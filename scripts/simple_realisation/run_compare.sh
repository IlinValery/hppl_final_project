...
do
    ...
    python basic/encryptor.py -i ../../data/fancy_guy.png -o ../../data/outputs/out.bmp -f ../../data/texts/$filename
    python basic/decryptor.py -ir ../../data/fancy_guy.png -ic ../../data/outputs/out.bmp -f ../../data/outputs/out_text.txt
